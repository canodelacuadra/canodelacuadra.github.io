...
Aprender a usar la línea de comandos nos abrirá infinitas posibilidades: sin duda es esencial en el desarrollo y la programación web, pero incluso los usuarios habituales que realizan tareas cotidianas se beneficiarán.

> Apple macOS y la mayoría de los servidores Linux usan casi todos los mismos comandos, por lo que este tutorial se aplica a ambos. Incluso si usas un PC con Windows, esto será útil para aprender ya que sus sitios web probablemente estén alojados en un servidor Linux.

#### Prerequisites

- No hay requisitos previos para este artículo: siempre que tenga conocimientos básicos de informática, podrá seguirlos

#### Objetivos

- Aprender qué es la interfaz de línea de comandos y cómo se relaciona con su computadora
- Aprenda algo de terminología básica relacionada con la línea de comando
- Aprenda los comandos más comunes y útiles.

#### Qué aprenderemos

- Mostrar el directorio actual y el contenido del directorio
...
- Copiar y pegar archivos y directorios
- Mover / cortar archivos y directorios
- Ejecutando múltiples comandos
- Cambio de permisos
- Ejecutar como administrador
- Conectarse a otra computadora o servidor
- Algunos comandos más útiles
- Usando un editor de texto básico

## ¿Qué es la línea de comandos?

Prometo que esto es lo más importante de entender, y que me estalló la cabeza por completo cuando finalmente lo entendí.

Windows, macOS, sea cual sea el sistema operativo que esté utilizando, es simplemente una representación visual de su computadora. Esto se conoce como interfaz gráfica de usuario (GUI) . Elimine el explorador de archivos, el escritorio, los iconos y todos los demás gráficos, y quedará con la línea de comando. En lugar de arrastrar y soltar, señalar y hacer clic, estás escribiendo. Esa es la única diferencia.

Realmente quiero reiterar esto. Se puede acceder a toda su computadora a través de la línea de comando. Puedes hacer todo a través de la línea de comando. Es la misma computadora que ya conoces y amas.

En una Mac, si abro Finder, esta es mi carpeta de inicio. Se llama taniarascia.

![](../images/Screen-Shot-2017-01-07-at-2.46.52-PM-1.png)

Puedo acceder a los mismos archivos exactos a través de un navegador web. Si abro Google Chrome y escribo /Users/taniarascia, estaré en el mismo lugar.

![](../images/Screen-Shot-2017-01-07-at-2.48.38-PM-1.png)

Lo mismo es cierto para la interfaz de línea de comandos. Voy a abrir Terminal.app abriendo la búsqueda de Spotlight (comando + barra espaciadora) y escribiré Terminal .
...
Vamos a aprender cómo hacer muchas de las cosas habituales que haces en una computadora con atajos de mouse o teclado. Vamos a movernos entre directorios, crear archivos y carpetas, eliminarlos, moverlos, copiarlos y pegarlos, y editar archivos. También puede presionar ``clear`` en cualquier momento para limpiar todo el historial y tener una pantalla limpia.

Hasta ahora, hemos aprendido tres cosas.

| Command | Meaning                                 | Description                                                   |
| ------- | --------------------------------------- | ------------------------------------------------------------- |
| `pwd`   | **Muestra el directorio de trabajo**    | saber dónde estás                                             |
| `ls`    | **Lista los contenidos del directorio** | ver qué archivos y directorios están en la localizacón acutal |
...
| Command      | Meaning                     | Description                                                 |
| ------------ | --------------------------- | ----------------------------------------------------------- |
| `pwd`        | **Print Working Directory** | Encuentra dónde estás                                       |
